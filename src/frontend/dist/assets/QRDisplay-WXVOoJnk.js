import { r as reactExports, j as jsxRuntimeExports, R as React, c as cn } from "./index-C_OiGXDq.js";
import { a as composeRefs, u as useComposedRefs } from "./createLucideIcon-B-k-gt5M.js";
...
function QRDisplay({
  ...
  const finderUrl = typeof window !== "undefined" ? `${window.location.origin}/found/${keyId}` : `/found/${keyId}`;
  reactExports.useEffect(() => {
    const canvas2 = canvasRef.current;
    if (!canvas2) return;
    browser.toCanvas(canvas2, finderUrl, {
      width: size,
      margin: 1,
      color: {
        dark: "#000000",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn("flex flex-col items-center gap-2", className), children: [
    ...
    showLabel && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-mono font-semibold text-primary tracking-wider", children: keyId })
  ] });
}
export {
  QRDisplay as Q,
